...
def graphdef_to_pbtxt(filename):
  with gfile.FastGFile(filename,'rb') as f:
    ...
    tf.import_graph_def(graph_def, name='')
    tf.compat.v1.train.write_graph(graph_def, os.getcwd(), 'new_model.pbtxt', as_text=True)
  return


graphdef_to_pbtxt('new_model.pb')  # here you can write the name of the file to be converted
